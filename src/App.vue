        ...
        <div class="row">
            ...
            <div class="column col-sm-12 col-lg-8">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="inserisci voce" aria-label="Cost description"
                           v-model="description">
                    <input type="text" class="form-control" placeholder="inserisci categoria" aria-label="Cost category"
                           v-model="category">
                    <input type="number" class="form-control" placeholder="inserisci costo" aria-label="Cost"
                           v-model="cost">
                    <div class="input-group-append">
                        <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">cadenza
                        </button>
            ...
            <div class="column col-sm-12 col-lg-4" v-if="datacollection">
